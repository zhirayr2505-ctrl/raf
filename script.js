...
const EVENT_MAP_URL = "https://www.google.com/maps/search/?api=1&query=%D4%B1%D5%B3%D5%A1%D5%BC%D5%B5%D5%A1%D5%B6%201%2F1%20%D4%B5%D6%80%D6%87%D5%A1%D5%B6";
// ====================
...
function main() {
  ...
  $("audioBtn").addEventListener("click", async () => {
    try {
      ...
      $("audioHint").textContent =
        "Չստացվեց միացնել ձայնը։ Ստուգիր, որ ունես web/audio/raf-voice.mp3";
      console.error(e);
    }
  });
  ...
  function sendRsvp(status, reason = null) {
    ...
    if (tg) {
      ...
      // Do NOT auto-close: user wants to stay and see confirmation.
      return;
    }
  ...
  // Remove Telegram MainButton (user asked to remove the blue bottom button)
  try {
    tg?.MainButton?.hide?.();
  } catch (_) {}
